...
public class EnemyAiTutorial : MonoBehaviour
{
    ...
    public int maxProjectiles = 40;

    private void Awake()
    {
        player = GameObject.Find("MaybeFix").transform;
    ...
    private void AttackPlayer()
    {
        ...
        if (!alreadyAttacked)
        {
            ...
            activeProjectiles.Add(rb.gameObject);

            // Удаляем старый снаряд, если их больше maxProjectiles
